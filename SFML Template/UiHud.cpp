...
void UiHud::Init()
{
	...
	gaugeHp.setSize(gauageHpMaxSize);
	...
	iconAmmoIcon.setPosition(25.f, BottomY + 10);
	gaugeHp.setPosition(500.f, BottomY);
...
void UiHud::SetHp(int hp, int max)
{
	...
	gaugeHp.setSize({ gauageHpMaxSize.x * value, gauageHpMaxSize.y });
	Utils::SetOrigin(gaugeHp, Origins::BL);
}
